...
public class JRSSTArgs
{
	...
	public boolean undecorated() { return (undecorated); }
	...
	public boolean upperleft() { return (upperleft); }
    boolean upperright = false;
	public boolean upperright() { return (upperright); }
    boolean lowerleft = false;
	public boolean lowerleft() { return (lowerleft); }
    boolean lowerright = false;
	public boolean lowerright() { return (lowerright); }
